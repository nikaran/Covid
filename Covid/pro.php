    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-50 text-thin text-line-height-1">Submission Details</h1><br>         
        </header>
		<center>
		...
		<?php
			...
			$link = mysqli_connect("localhost", "root", "", "test");
			 if($link === false){
				...
				$sql = "INSERT INTO nik (name, email,aadhar) VALUES ('$first_name', '$email','$aadhar')";
