      ...
      <article>
		...
		<center>
		    <?php if (isset($_POST['form_submitted'])): ?> 
				...
				<p>Ordered Successfully <?php echo $_POST["order_details"]; ?><br></p></center>
		...
		<?php
			...
			$link = mysqli_connect("localhost", "root", "", "test");
			 if($link === false){
				...
				$sql = "INSERT INTO grsub(name, email,contact_no,district,Area,complete_address, acontact_no) VALUES ('$first_name', '$email','$contact_no','$district','$Area', '$complete_address','$acontact_no'
				)";
